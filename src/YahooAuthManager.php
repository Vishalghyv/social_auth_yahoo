...
namespace Drupal\social_auth_yahoo;
...
/**
 * Contains all the logic for yahoo OAuth2 authentication.
 */
class YahooAuthManager extends OAuth2Manager {
  ...
  public function __construct(ConfigFactory $config_factory,
    ...
    parent::__construct($config_factory->get('social_auth_yahoo.settings'),
                        $logger_factory,
  ...
  public function authenticate() {
    try {
      ...
      $this->loggerFactory->get('social_auth_yahoo')
  ...
  public function requestEndPoint($method, $path, $domain = NULL, array $options = []) {
    if (!$domain) {
      $domain = 'https://api.login.yahoo.com';
    }
